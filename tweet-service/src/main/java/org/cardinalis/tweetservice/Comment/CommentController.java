...
//            producer.send("deleteComment", message);
            Comment comment;
            if (commentId != null) {
                comment = commentService.deleteCommentById(commentId);
            }
            else {
                comment = commentService.deleteCommentByTweet_IdAndUsername(tweetId, username);
            }
    ...
    public ResponseEntity<Map<String, Object>> getComment(
        ...
        try {
            ...
            if (!commentId.isEmpty()) {
                comment = commentService.getCommentById(Long.parseLong(commentId));
            }
            else {
    ...
    public ResponseEntity<Map<String, Object>> getComments(
        ...
        try {
            ...
            if (!tweetId.isEmpty()) {
                comments = commentService.getCommentsByTweet(Long.parseLong(tweetId), pageNo, pageSize);
            }
            else {
                comments = commentService.getAll(pageNo, pageSize);
            }
